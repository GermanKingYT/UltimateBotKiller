...
class phpJSO { 
    ...
    */ 
    ...
    function &getObfuscatedCode( ) { 
      $_d = ( null === $this->_obfuscatedCode )? $this->_obfuscateCode( ): $this->_obfuscatedCode; 
      return $_d;
    } 
    ...
    function &_obfuscateCode( ) { 
      $this->_charFirst = ''; 
      $this->_obfuscatedCode = '/*** Ultimate Bot Killer 1.0 ***/'."\n"; 
    ...
    function ubk($_s) {
      $this->setSourceCodeByRef($_s);
      $_s =& $this->getObfuscatedCode( ); 
      return $_s;
    }
...
class Packer {
	...
	private function _bootStrap($packed, $keywords) {
		...
		// the whole thing
		return 'eval(/*** Ultimate Bot Killer 1.0 ***/' . $unpack . '(' . $params . "))\n";
	}
